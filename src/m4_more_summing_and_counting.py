...
# Test 2:
    expected = 6
    answer = count_cosines_from(3, 8, -1)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)
# Test 3:
    expected = 11
    answer = count_cosines_from(-3, 7, -1)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)
# Test 4:
    expected = 2
    answer = count_cosines_from(2, 10, 0.38)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)
# Test 5:
    expected = 27
    answer = count_cosines_from(1, 57, 0.10)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)
# Test 6:
    expected = 14
    answer = count_cosines_from(7, 28, -0.46)
...
# Test 2:
    ...
    # Test 3:
    expected = 4.1468  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(1, 35)
